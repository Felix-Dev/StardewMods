...
* This mod is compatible with the mod [Prismatic Tools](https://www.nexusmods.com/stardewvalley/mods/2428). Enable the option `RemoveToolDuplicates` so that rented tools will be removed from the inventory.
