...
namespace FelixDev.StardewMods.FeTK.Framework.Services
{
    ...
    public class QuestMail : Mail, IQuestMailContent
    {
        ...
        /// </summary>
        /// <exception cref="ArgumentOutOfRangeException">The quest ID is less than one and not equal to the value "NO_QUEST".</exception>
        ...
        /// </summary>
        public bool IsAutomaticallyAccepted { get; }
    }
}
